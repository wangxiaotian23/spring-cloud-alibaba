package com.imooc.usercenter.util;
...
public class JwtOperator {
    ...
    public Claims getClaimsFromToken(String token) {
        try {
            ...
            throw new IllegalArgumentException("token解析错误.");
        }
    }
    ...
    public static void main(String[] args) {
        ...
        // 将我改成上面生成的token!!!
        String someToken = "eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2MTEyOTU2MDIsImV4cCI6MTYxMjUwNTIwMn0.N3aG_uTfj3bcSQY4rBB1SwcaOXS2xZyTUNPTYER1iDw";
        ...
        String encodedPayload = "eyJpZCI6IjEiLCJpYXQiOjE2MTEyOTU2MDIsImV4cCI6MTYxMjUwNTIwMn0";
        // 测试5: 解密Payload
        byte[] payload = Base64.decodeBase64(encodedPayload.getBytes());
        System.out.println(new String(payload));

        // 测试6: 这是一个被篡改的token，因此会报异常，说明JWT是安全的
        jwtOperator.validateToken("eyJhbGciOiJIUzI1NiJ9.eyJpZCI6IjEiLCJpYXQiOjE2MTEyOTU2MDIsImV4cCI6MTYxMjUwNTIwMn0.N3aG_uTfj3bcSQY4rBB1SwcaOXS2xZyTUNPTYER1iDw");
    }
}
